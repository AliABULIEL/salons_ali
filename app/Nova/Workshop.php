...
class Workshop extends Resource
{
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Fields\BelongsToMany::make(__('Employees'), 'users', User::class),

            Fields\Number::make(__('Clients count'), 'clients_count')->sortable()->default(1),

            Fields\HasMany::make(__('Working hours'), 'opening_hours', WorkingHour::class),
        ];
    }
