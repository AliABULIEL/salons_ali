...
Nova.booting(function (Vue, router, store) {
  Vue.component('plan', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        plan: function plan() {
            return this.lang[this.card.type];
        }
    }
});
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("h1", { staticClass: "text-center text-xl text-80 font-light" }, [
          _vm._v(
            "\n            לפי התוכנית אליה הנך משויך, אתה רשאי לפרסם הנחה אחת "
          ),
