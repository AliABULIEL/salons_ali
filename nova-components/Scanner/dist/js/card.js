...
Nova.booting(function (Vue, router, store) {
  Vue.component('scanner', __webpack_require__(2));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_verification_code_input__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_verification_code_input___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_verification_code_input__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        CodeInput: __WEBPACK_IMPORTED_MODULE_0_vue_verification_code_input___default.a
    },
    props: ['card'],
    ...
    methods: {
        ...
        scan: function scan(code) {
            ...
            Nova.request().post('/nova-vendor/scanner/scan', {
                ...
                _this.loading = false;
                _this.$toasted.show(response.data.message, { type: response.data.status });
...
var render = function() {
  ...
  return _c(
    "loading-card",
    { staticClass: "px-6 py-8", attrs: { loading: _vm.loading } },
    [
      _c("h1", { staticClass: "text-3xl text-90 font-normal" }, [
        _vm._v("Order Check")
      ]),
      _vm._v(" "),
      _c("p", { staticClass: "mb-3 text-70 font-normal text-xl mt-3 mb-6" }, [
        _vm._v("Enter the order code:")
      ]),
      _vm._v(" "),
      _c("CodeInput", {
        key: _vm.show,
