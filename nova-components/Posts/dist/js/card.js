...
Nova.booting(function (Vue, router, store) {
  Vue.component('posts', __webpack_require__(2));
});
  ...
  return _c("section", { staticClass: "text-gray-700 body-font" }, [
    _c("div", { staticClass: "container px-5 py-24 mx-auto" }, [
      _c(
        ...
        _vm._l(_vm.card.content, function(post) {
          return _c("div", { staticClass: "p-4 w-1/4" }, [
            _c(
              "div",
              { staticClass: "h-full rounded-lg overflow-hidden card" },
              [
                _c("img", {
                  staticClass:
                    "lg:h-48 md:h-36 w-full object-cover object-center",
                  attrs: { src: "/image/medium/" + post.image, alt: "blog" }
                }),
                _vm._v(" "),
                    ...
                    [
                      _c(
                        "router-link",
                        {
                          ...
                          attrs: { to: "/resources/posts/" + post.id }
                        },
                        [
                          _vm._v(
                            "\n                    קרא עוד\n                    "
